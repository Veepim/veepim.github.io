new Vue({
	...
	data: {
		...
		lotteryNum: 3,
		data: [{
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball1-20180702.png",
			"translateXPos": 0,
			"translateYPos": 182,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball2-20180702.png",
			"translateXPos": 95,
			"translateYPos": 204,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball3-20180702.png",
			"translateXPos": -158,
			"translateYPos": 169,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball4-20180702.png",
			"translateXPos": 174,
			"translateYPos": 160,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball5-20180702.png",
			"translateXPos": -101,
			"translateYPos": 198,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball6-20180702.png",
			"translateXPos": -204,
			"translateYPos": 105,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball7-20180702.png",
			"translateXPos": 122,
			"translateYPos": 115,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball8-20180702.png",
			"translateXPos": 79,
			"translateYPos": 32,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball9-20180702.png",
			"translateXPos": -62,
			"translateYPos": 112,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball10-20180702.png",
			"translateXPos": 29,
			"translateYPos": 108,
		}, {
			"imgUrl": "../public/image/niudanji_02/eggBeater2-ball11-20180702.png",
			"translateXPos": -156,
			"translateYPos": 91,
		}]
	},
		...
		runBall() {
			...
			if(this.runBallOver == false) {
				this.data.forEach(ball => {
					// 重置角度、速度、坐标参数
					ball.angle = -Math.random() * (Math.PI - 1) - 0.5,
						ball.speed = -Math.random() * 100 + 1500,
						ball.x = ball.translateXPos,
						ball.y = ball.translateYPos,
		...
		finishBall(idx) {
			...
			let idxTimer = setInterval(() => {
				this.data.forEach(ball => {
					...
					let tempStyle = ball.style;
					let dis = 40 * (frameCount / 5.0) * (this.frameTick / 1000);
